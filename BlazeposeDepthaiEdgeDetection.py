...
POSE_DETECTION_MODEL = str(SCRIPT_DIR / "models/saved_model.blob")
DETECTION_POSTPROCESSING_MODEL = str(SCRIPT_DIR / "custom_models/DetectionBestCandidate_sh1.blob")
TEMPLATE_MANAGER_SCRIPT = str(SCRIPT_DIR / "template_detection_manager_script.py")
